...
class CompanyImageController extends BaseController
{
    ...
    public function store()
    {
        ...
        if (!is_dir(WRITEPATH . 'uploads/img-company')) {
            mkdir(WRITEPATH . 'uploads/img-company', 0777, TRUE);
        }
        ...
        foreach ($images as $image) {
            if ($image->isValid() && !$image->hasMoved()) {
                ...
                $image->move(WRITEPATH . 'uploads/img-company', $imageName);
    ...
    public function update($id)
    {
        ...
        if ($image->isValid() && !$image->hasMoved()) {
            ...
            unlink(WRITEPATH . 'uploads/img-company/' . $oldImages->image);
        }
        return redirect()->back();
    }
    ...
    public function delete($id)
    {
        ...
        unlink(WRITEPATH . 'uploads/img-company/' . $image->image);
        return redirect()->back();
    }
}
