                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="modal fade text-center" id="imagesModal<?= $product->id ?>"
                                        tabindex="-1" aria-labelledby="imagesLabel" aria-hidden="true">
                                                    ...
                                                    <div id="carouselProductImages<?= $product->id ?>"
                                                        ...
                                                        <div class="carousel-inner">
                                                            ...
                                                            <div
                                                                ...
                                                                <img src="<?= base_url('uploads/img-product/' . $image->image) ?>"
                                                                    class="w-100" alt="...">
                                                            </div>
                                                            <?php } ?>
                                                        </div>
                                ...
                                <td>
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#edit<?= $product->id ?>"
                                        class="btn btn-warning btn-sm edit-button" data-detail="<?= htmlspecialchars($product->detail) ?>">
                                                        ...
                                                        <div class="form-body">
                                                            ...
                                                            <div class="col-md-12 form-group">
                                                                ...
                                                                <textarea name="detail" id="summernote-product-<?= $product->id ?>"
                                                                    class="summernote-product"></textarea>
                                                                    <script>
                                                            ...
                                                            <div class="col-md-12 form-group">
                                                                ...
                                                                <input type="int" id="stock" class="form-control"
                                                                    name="stock" required value="<?= $product->stok ?>">
                                                            </div>
                                                            <div class="col-md-12 form-group">
                                                                <label for="variant">Variant</label>
                                                                <input type="text" id="variant"
                                                                    class="form-control variant-product" name="variant"
                                                                    required value="<?= $product->variant ?>">
                                                            </div>
                                                            <div class="col-md-12 form-group">
                                                                <label for="price">Price</label>
                                                                <input type="text" id="price"
                                                                    class="form-control price-product" name="price"
                                                                    placeholder="Rp 100.000" required
                                                                    value="<?= $product->harga ?>">
                                                            </div>
                                                            <input type="file" class="multiple-files-filepond" name="images[]" multiple data-images='<?= json_encode(array_map(function($image) { return base_url('uploads/img-product/' . $image->image); }, $product->images)) ?>'/>
            ...
            <div class="modal fade" id="tambah" tabindex="-1" aria-labelledby="tambahLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="form form-horizontal" id="form-product" method="post"
                                enctype="multipart/form-data" action="<?= base_url('products/create') ?>">
                                <div class="form-body">
                                    <div class="col-md-12 form-group">
                                        <label for="name">Name</label>
                                    ...
                                    <div class="col-md-12 form-group">
                                        <label for="variant">Variant</label>
                                        <input type="text" id="variant" class="form-control variant-product"
